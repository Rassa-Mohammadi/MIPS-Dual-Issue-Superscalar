module tb_scenario3_dual;
    ...
    initial begin
        ...
        instructions[0]  = 32'b00100000000001000000000000100000;  // addi $a0, $zero, 32
        ...
        instructions[42] = 32'b00000001010010110101000000100110;  // xor  $t2, $t2, $t3
        instructions[43] = 32'b00000001100010110110000000100000;  // add  $t4, $t4, $t3
        instructions[44] = 32'b00000001101010110110100000100010;  // sub  $t5, $t5, $t3
        instructions[45] = 32'b00000001110010110111000000100100;  // and  $t6, $t6, $t3
        instructions[46] = 32'b00000001111010110111100000100101;  // or   $t7, $t7, $t3
        instructions[47] = 32'b00000011000010111100000000100110;  // xor  $t8, $t8, $t3
        instructions[48] = 32'b00000011001010111100100000100000;  // add  $t9, $t9, $t3
        instructions[49] = 32'b00000000010010110001000000100010;  // sub  $v0, $v0, $t3
        instructions[50] = 32'b00000000011010110001100000100100;  // and  $v1, $v1, $t3
        instructions[51] = 32'b00000010000010111000000000100101;  // or   $s0, $s0, $t3
        instructions[52] = 32'b00000010001010111000100000100110;  // xor  $s1, $s1, $t3
        instructions[53] = 32'b00000010010010111001000000100000;  // add  $s2, $s2, $t3
        instructions[54] = 32'b00000010011010111001100000100010;  // sub  $s3, $s3, $t3
        instructions[55] = 32'b00000010100010111010000000100100;  // and  $s4, $s4, $t3
        instructions[56] = 32'b00000010101010111010100000100101;  // or   $s5, $s5, $t3
        instructions[57] = 32'b00000010110010111011000000100110;  // xor  $s6, $s6, $t3
        instructions[58] = 32'b00000010111010111011100000100000;  // add  $s7, $s7, $t3
        instructions[59] = 32'b00000001001010110100100000100010;  // sub  $t1, $t1, $t3
        instructions[60] = 32'b00000001010010110101000000100100;  // and  $t2, $t2, $t3
        instructions[61] = 32'b00000001100010110110000000100101;  // or   $t4, $t4, $t3
        instructions[62] = 32'b00100001011010110000000000000001;  // addi $t3, $t3, 1
        instructions[63] = 32'b00000001101010000110100000100110;  // xor  $t5, $t5, $t0
        instructions[64] = 32'b00000001110010000111000000100000;  // add  $t6, $t6, $t0
        instructions[65] = 32'b00000001111010000111100000100010;  // sub  $t7, $t7, $t0
        instructions[66] = 32'b00000011000010001100000000100100;  // and  $t8, $t8, $t0
        instructions[67] = 32'b00000011001010001100100000100101;  // or   $t9, $t9, $t0
        instructions[68] = 32'b00000000010010000001000000100110;  // xor  $v0, $v0, $t0
        instructions[69] = 32'b00000000011010000001100000100000;  // add  $v1, $v1, $t0
        instructions[70] = 32'b00000010000010001000000000100010;  // sub  $s0, $s0, $t0
        instructions[71] = 32'b00000010001010001000100000100100;  // and  $s1, $s1, $t0
        instructions[72] = 32'b00000010010010001001000000100101;  // or   $s2, $s2, $t0
        instructions[73] = 32'b00000010011010001001100000100110;  // xor  $s3, $s3, $t0
        instructions[74] = 32'b00000010100010001010000000100000;  // add  $s4, $s4, $t0
        instructions[75] = 32'b00000010101010001010100000100010;  // sub  $s5, $s5, $t0
        instructions[76] = 32'b00000010110010001011000000100100;  // and  $s6, $s6, $t0
        instructions[77] = 32'b00000010111010001011100000100101;  // or   $s7, $s7, $t0
        instructions[78] = 32'b00000001001010000100100000100110;  // xor  $t1, $t1, $t0
        instructions[79] = 32'b00000001010010000101000000100000;  // add  $t2, $t2, $t0
        instructions[80] = 32'b00000001100010000110000000100010;  // sub  $t4, $t4, $t0
        instructions[81] = 32'b00000001101010000110100000100100;  // and  $t5, $t5, $t0
        instructions[82] = 32'b00000001110010000111000000100101;  // or   $t6, $t6, $t0
        instructions[83] = 32'b00000001111010000111100000100110;  // xor  $t7, $t7, $t0
        instructions[84] = 32'b00000011000010001100000000100000;  // add  $t8, $t8, $t0
        instructions[85] = 32'b00000011001010001100100000100010;  // sub  $t9, $t9, $t0
        instructions[86] = 32'b00000000010010000001000000100100;  // and  $v0, $v0, $t0
        instructions[87] = 32'b00000000011010000001100000100101;  // or   $v1, $v1, $t0
        instructions[88] = 32'b00000010000010001000000000100110;  // xor  $s0, $s0, $t0
        instructions[89] = 32'b00000010001010001000100000100000;  // add  $s1, $s1, $t0
        instructions[90] = 32'b00000010010010001001000000100010;  // sub  $s2, $s2, $t0
        instructions[91] = 32'b00000010011010001001100000100100;  // and  $s3, $s3, $t0
        instructions[92] = 32'b00000010100010001010000000100101;  // or   $s4, $s4, $t0
        instructions[93] = 32'b00000010101010001010100000100110;  // xor  $s5, $s5, $t0
        instructions[94] = 32'b00000010110010001011000000100000;  // add  $s6, $s6, $t0
        instructions[95] = 32'b00000010111010001011100000100010;  // sub  $s7, $s7, $t0
        instructions[96] = 32'b00000001001010000100100000100100;  // and  $t1, $t1, $t0
        instructions[97] = 32'b00000001010010000101000000100101;  // or   $t2, $t2, $t0
        instructions[98] = 32'b00000001100010000110000000100110;  // xor  $t4, $t4, $t0
        instructions[99] = 32'b00000001101010000110100000100000;  // add  $t5, $t5, $t0
        instructions[100] = 32'b00000001110010000111000000100010; // sub  $t6, $t6, $t0
        instructions[101] = 32'b00000001111010000111100000100100; // and  $t7, $t7, $t0
        instructions[102] = 32'b00010100100000001111111110101111; // bnez $a0, loop (target = 22, offset = -81)
        instructions[103] = 32'b00000000000000000000000000000000; // nop
        instructions[104] = 32'b00000000000000000000000000000000; // nop
        instructions[105] = 32'b00000000000000000000000000000000; // nop

        // done: (index 106)
        instructions[106] = 32'b00001000000000000000000001101010; // j done (target = 106)
        instructions[107] = 32'b00000000000000000000000000000000; // nop
        instructions[108] = 32'b00000000000000000000000000000000; // nop
        instructions[109] = 32'b00000000000000000000000000000000; // nop
